...
class DemoBox(QMainWindow, Ui_MainWindow):
    ...
    def init_maq20(self):
        ...
        try:
            self.maq20 = MAQ20(
                ip_address=self.ip_address_line.displayText(),
            ...
            self.status_line.setText(
                "Connected to {}".format(self.ip_address_line.displayText())
            )
    ...
    def motor_pot_1_val(self, p_int):
        try:
            ...
            while (
                not (new_value - 0.01 < current_value < new_value + 0.01)
    ...
    def _update_tc_external(self):
        ...
        self.tc_touch_line_edit.setText(
            "{} {}".format(
