...
from maq20.modbus_client.constants import Defaults, FramerState
from maq20.modbus_client.interfaces import IModbusFramer
from maq20.modbus_client.utilities import check_crc, compute_crc
from maq20.modbus_client.utilities import check_lrc, compute_lrc
...
class ModbusSocketFramer(IModbusFramer):
    ...
    def check_frame(self):
        ...
        if len(self.buffer) >= self.header_size:
            self.header["tid"], self.header["pid"], self.header["len"], self.header[
                "uid"
