...
from maq20.modbus_client.factory import ClientDecoder
from maq20.modbus_client.exceptions import ParameterException
from maq20.modbus_client.exceptions import ConnectionException
from maq20.modbus_client.transaction import FifoTransactionManager
from maq20.modbus_client.transaction import DictTransactionManager
from maq20.modbus_client.transaction import ModbusSocketFramer, ModbusBinaryFramer
from maq20.modbus_client.transaction import ModbusAsciiFramer, ModbusRtuFramer
from maq20.modbus_client.client.common import ModbusClientMixin
    ...
    def connect(self):
        ...
        try:
            ...
            self.socket = socket.create_connection(
                address, timeout=Defaults.Timeout, source_address=self.source_address
            )
        except socket.error as msg:
            _logger.error(
                "Connection to ({0}, {1}) failed: {2}".format(self.host, self.port, msg)
            )
            self.close()
...
# Exported symbols
__all__ = ["ModbusTcpClient", "ModbusUdpClient", "ModbusSerialClient"]
